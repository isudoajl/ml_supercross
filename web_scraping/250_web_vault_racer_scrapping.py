...
with open('/ml_supercross/web_scraping/data_collection/generated_urls_250.json', 'r') as file:
    urls = json.load(file)
...
output_file_path = '/ml_supercross/web_scraping/data_collection/250_races.json'
